<?php
/**
 * Shared layout header — Social Media Manager
 *
 * Set these variables BEFORE including this file:
 *   $pageTitle   — text for the <title> tag
 *   $activeNav   — 'dashboard' | 'create-post' | 'settings' | 'post-history'
...
<head>
    ...
    <title><?php echo htmlspecialchars($pageTitle); ?> - Social Media Manager</title>
    ...
    <div class="app-shell">
        ...
        <aside class="sidebar" id="sidebar">
            ...
            <ul class="nav-list">
                ...
                <li>
                    <a href="create-post.php" class="nav-item <?php echo ($activeNav ?? '') === 'create-post' ? 'active' : ''; ?>">
                        <svg viewBox="0 0 24 24" fill="none" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                            <path d="M12 20h9"/>
                ...
                <li>
                    <a href="settings.php" class="nav-item <?php echo ($activeNav ?? '') === 'settings' ? 'active' : ''; ?>">
                        <svg viewBox="0 0 24 24" fill="none" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                ...
                <li>
                    <a href="post-history.php" class="nav-item <?php echo ($activeNav ?? '') === 'post-history' ? 'active' : ''; ?>">
                        <svg viewBox="0 0 24 24" fill="none" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                            <path d="M3 3v18h18"/>
        ...
        <main class="main">
            ...
            <div class="topbar">
                <div class="topbar-left">
                    ...
                    <div>
                        <h1><?php echo htmlspecialchars($topbarTitle ?? $pageTitle); ?></h1>
